    ...
    if ($_POST["mode"] == "new_user") {
        ...
        if ($doit == true) {
          ...
          //if password expiration option is enabled,  calculate the expiration date of the password
            ...
            "', university = '"         . add_escape_custom(trim((isset($_POST['university']) ? $_POST['university'] : ''))) .
            "'";
                    ...
                    <tbody>
                        ...
                        foreach ($result4 as $iter) {
                            ...
                            print "<tr>
                                ...
                                <td align='left'><span>" .text($isMfa) . "</td><td align='left'><span>".text($iter{"university"})."</td>";
                            print "</tr>\n";
                        }
                        ?>
                    </tbody>
