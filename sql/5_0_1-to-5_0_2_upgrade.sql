...
#IfMissingColumn  openemr_postcalendar_events  pc_speciality
ALTER TABLE openemr_postcalendar_events ADD pc_speciality VARCHAR(50);
#EndIf

#IfNotRow list_options list_id speciality option_id 1
INSERT INTO list_options(list_id,option_id,title,seq,activity) VALUES ('speciality','1','Family Medicine Consultation','1','1');
#EndIf

#IfNotRow list_options list_id speciality option_id 2
INSERT INTO list_options(list_id,option_id,title,seq,activity) VALUES ('speciality','2','Dental','2','1');
#EndIf

#IfNotRow list_options list_id speciality option_id 3
INSERT INTO list_options(list_id,option_id,title,seq,activity) VALUES ('speciality','3','Cardiology','3','1');
#EndIf